# noqa
"""
Module responsible for building FHIR JSON that captures the organization 
conductinng the patient's study
"""
...
from d3b_api_client_cli.fhir.entity_builders.organization.mapping import *
...
class Organization(FhirResourceBuilder):
    """
    Build FHIR Organization from Dataservice Investigator
    """
